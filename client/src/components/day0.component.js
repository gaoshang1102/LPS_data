        ...
        <div className = "main-container" >
            ...
            <form onSubmit={this.onSubmit}>
                <select className = "dropdown" name = "selected" value={selected} onChange={this.onChangeOption}>
                    <option selected  >Choose your Visualization Style</option>
                    <option >tSNE</option>
                    <option>UMAP</option>
                </select>
            ...
            <img src={image} alt=" HERE" className="Api"/>
            </div>
            <div className="img-container-2">
            <img src={imagec} alt=" HERE" className="Api"/>
            </div>
            </div>
            ...
            <div className="input-group input-group-sm mb-3">
                ...
                <input type="text"  name = "gene" value={gene}  onKeyDown={this.onKeyPress} onChange={this.onChangeOption} class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm"/>
                </div>
            </div>
            </div>
            <div className="imgene">
            <p>
            <img src={imageg} alt=" HERE" className="gene"/>
            </p>
            </div>
            </div>
            ...
            <div className="go-container">
                ...
                <div>
                <img src={imagego} alt=" HERE" className="Api1"/>
                </div>
            </div>
            </form> 
        </div>
